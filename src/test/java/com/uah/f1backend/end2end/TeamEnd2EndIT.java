...
public class TeamEnd2EndIT {
    ...
    void insertAndDeleteTeam() throws Exception {
        ...
        // Insert team in db
        final var insertResponseAsString = mockMvc.perform(post("/teams")
                        .content(gson.toJson(teamDTORequest))
        ...
        final var getResponseAsString = mockMvc.perform(get("/teams/" + actualTeamModel.getId())
                        .contentType(MediaType.APPLICATION_JSON))
        ...
        // Remove team from db
        final var deleteResponseAsString = mockMvc.perform(delete("/teams/" + actualTeamModel.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse()
