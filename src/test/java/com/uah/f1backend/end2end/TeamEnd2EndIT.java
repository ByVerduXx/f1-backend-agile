...
public class TeamEnd2EndIT {
    ...
    void insertAndDeleteTeam() throws Exception {
        ...
        Assertions.assertEquals(
                teamDTORequest.getName(), teamResponseEntity.getBody().getName());
        Assertions.assertEquals(
                teamDTORequest.getLogo(), teamResponseEntity.getBody().getLogo());
        Assertions.assertEquals(
                teamDTORequest.getTwitter(), teamResponseEntity.getBody().getTwitter());
        ...
        final var actualTeamModel = (TeamModel) entityManager
                .createQuery(
                        "from team where id=" + teamResponseEntity.getBody().getId())
                .getResultList()
                .get(0);
        ...
        Assertions.assertEquals(
                teamDTORequest.getName(), getResponseEntity.getBody().getName());
        Assertions.assertEquals(
                teamDTORequest.getLogo(), getResponseEntity.getBody().getLogo());
        Assertions.assertEquals(
                teamDTORequest.getTwitter(), getResponseEntity.getBody().getTwitter());

        // Update team
        final var updatedTeamDTORequest = new TeamDTORequest("name2", "logo2", "twitter2");
        final var getUpdateResponseEntity =
                teamRestController.updateTeamById(actualTeamModel.getId(), updatedTeamDTORequest);

        Assertions.assertEquals(
                updatedTeamDTORequest.getName(),
                getUpdateResponseEntity.getBody().getName());
        Assertions.assertEquals(
                updatedTeamDTORequest.getLogo(),
                getUpdateResponseEntity.getBody().getLogo());
        Assertions.assertEquals(
                updatedTeamDTORequest.getTwitter(),
                getUpdateResponseEntity.getBody().getTwitter());
        ...
        Assertions.assertEquals(
                updatedTeamDTORequest.getName(),
                deletedTeamResponseEntity.getBody().getTeamName());
