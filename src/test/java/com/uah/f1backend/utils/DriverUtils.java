...
public class DriverUtils {
    ...
    public static DriverDTOResponse dummyDriverDTONullTeamResponse() {
        return new DriverDTOResponse(1, "name", "lastname", "nl", 1, "photo.png", "@twitter", dummyCountryDTOResponse() , null);
    }
    ...
    public static DriverDTOResponse dummy2DriverDTOResponseIT() {
        return new DriverDTOResponse(1, "name2", "lastname2", "nl2", 1, "photo2.png", "@twitter", dummyCountryDTOResponse(), 1);
    }
    ...
    public static List<DriverDTOResponse> dummyListDriverDTOResponse() {
        ...
        for (var i = 0; i < 3; i++) {
            dummyList.add(new DriverDTOResponse(
                    i, "name" + i, "lastname" + i, "nl" + i, i, String.format("photo%s.png", i), "@twitter" + i, dummyCountryDTOResponse(), 1));
        }
        return dummyList;
    }
